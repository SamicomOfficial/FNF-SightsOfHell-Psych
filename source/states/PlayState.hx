...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		scoreTxt.setFormat(Paths.font("waltograph.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt = new FlxText(400, healthBar.y - 90, FlxG.width - 800, Language.getPhrase("REAL SUFFERING IS NOT KNOWN REAL SUFFERING IS NOT KNOWN REAL SUFFERING IS NOT KNOWN REAL SUFFERING IS NOT KNOWN").toUpperCase(), 32);
		botplayTxt.setFormat(Paths.font("waltograph.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
